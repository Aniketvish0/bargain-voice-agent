        ...
        {missingFn ? (
          ...
          <>
            ...
            <p>
              ...
              so a token minted anywhere else will not validate here. Clear the
              token below and sign in again — the console can mint its own session
              and does not need the Telegram bot to do it.
            </p>
          </>
        ) : null}
